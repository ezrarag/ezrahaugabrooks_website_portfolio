...
CREATE TABLE IF NOT EXISTS developer_projects (
  ...
  project_url TEXT,
  github_url TEXT,
  live_url TEXT, -- Add live URL for iframe embedding
  technologies TEXT[], -- Array of technology names
  status TEXT DEFAULT 'completed', -- completed, in_progress, planned
  featured BOOLEAN DEFAULT false,
  sort_order INTEGER DEFAULT 0,
...
-- Insert sample data for developer projects
INSERT INTO developer_projects (title, subtitle, description, technologies, featured, sort_order, image_url, project_url, github_url, live_url) VALUES
('E-commerce Platform', 'Next.js • TypeScript • Stripe', 'Full-stack e-commerce solution with payment processing', ARRAY['Next.js', 'TypeScript', 'Stripe', 'PostgreSQL'], true, 1, 'https://example.com/ecommerce.png', 'https://example.com/ecommerce', 'https://github.com/example/ecommerce', 'https://ecommerce.example.com'),
('Real-time Dashboard', 'React • WebSocket • D3.js', 'Interactive analytics dashboard with real-time data visualization', ARRAY['React', 'WebSocket', 'D3.js', 'Node.js'], true, 2, 'https://example.com/dashboard.png', 'https://example.com/dashboard', 'https://github.com/example/dashboard', 'https://dashboard.example.com'),
('Mobile Banking App', 'React Native • Firebase', 'Cross-platform mobile banking application', ARRAY['React Native', 'Firebase', 'Redux'], true, 3, 'https://example.com/banking.png', 'https://example.com/banking', 'https://github.com/example/banking', 'https://banking.example.com'),
('API Gateway Service', 'Node.js • Docker • Redis', 'Microservices API gateway with caching and rate limiting', ARRAY['Node.js', 'Docker', 'Redis', 'Express'], true, 4, 'https://example.com/api.png', 'https://example.com/api', 'https://github.com/example/api', 'https://api.example.com');
...
-- Insert sample data for developer projects
INSERT INTO developer_projects (title, subtitle, description, image_url, project_url, github_url, live_url, technologies, featured, sort_order) VALUES
('E-commerce Platform', 'Next.js • TypeScript • Stripe', 'Full-stack e-commerce solution with payment processing', 'https://example.com/ecommerce.png', 'https://example.com/ecommerce', 'https://github.com/example/ecommerce', 'https://ecommerce.example.com', ARRAY['Next.js', 'TypeScript', 'Stripe', 'PostgreSQL'], true, 1),
('Real-time Dashboard', 'React • WebSocket • D3.js', 'Interactive analytics dashboard with real-time data visualization', 'https://example.com/dashboard.png', 'https://example.com/dashboard', 'https://github.com/example/dashboard', 'https://dashboard.example.com', ARRAY['React', 'WebSocket', 'D3.js', 'Node.js'], true, 2),
('Mobile Banking App', 'React Native • Firebase', 'Cross-platform mobile banking application', 'https://example.com/banking.png', 'https://example.com/banking', 'https://github.com/example/banking', 'https://banking.example.com', ARRAY['React Native', 'Firebase', 'Redux'], true, 3),
('API Gateway Service', 'Node.js • Docker • Redis', 'Microservices API gateway with caching and rate limiting', 'https://example.com/api.png', 'https://example.com/api', 'https://github.com/example/api', 'https://api.example.com', ARRAY['Node.js', 'Docker', 'Redis', 'Express'], true, 4);
